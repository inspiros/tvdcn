...
namespace tvdcn {
    namespace ops {
        namespace {
            ...
            template<typename scalar_t>
            static __device__ __forceinline__ scalar_t interpolate_sample(
                    const scalar_t *input,
                    const int depth,
                    const int height,
                    const int width,
            ...
            template<typename scalar_t>
            static __device__ __forceinline__ void interpolate_insert(
                    scalar_t *output,
                    const int depth,
                    const int height,
                    const int width,
            ...
            template<typename scalar_t>
            static __device__ __forceinline__ scalar_t trilinear_coordinate_weight(
                    const scalar_t *input,
                    const int depth,
                    const int height,
                    const int width,
